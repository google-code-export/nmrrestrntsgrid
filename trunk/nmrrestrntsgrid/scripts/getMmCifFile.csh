...
# USE:  getFilesFromGrid.csh 2grg,2fcg
  


set run_id          = all
set urlBase         = http://www.bmrb.wisc.edu/WebModule/MRGridServlet
...
# Comment out if you want to get all files
#set par3            = ""
...
wget -v -o $wgetLogFile -O $zipFile $urlBase'?'"$par1&$par2&$par3"
if ( $status ) then
    echo "ERROR: failed to wget from url: $url"
    exit 1
endif
