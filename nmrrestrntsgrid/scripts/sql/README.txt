...
-d- data/extract view: overviewall and other views to csv:
    sudo su
    rm /tmp/*.csv >& /dev/null
    On nmr machine command takes a while to run. (28 min 50.72 sec)
    ...
    scp -P 39676 jd@localhost-nmr:/Users/jd/NRG/Results/weekly20090803/\*.csv /Users/jd/Desktop/Werk/NRG_Paper/csv
